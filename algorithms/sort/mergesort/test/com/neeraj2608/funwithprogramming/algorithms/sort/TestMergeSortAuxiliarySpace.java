...
public class TestMergeSortAuxiliarySpace{

  @Test
  public void testMergeSortInPlace(){
    int[] arr1 = {1,2,3,4,5};
    int[] arr3 = {1,2,3,4,5};
    int[] arr4 = MergeSortAuxiliarySpace.mergeSortAuxiliarySpace(arr3);
    assertArrayEquals(arr1, arr4);
    
    arr3 = new int[]{5,4,3,2,1};
    arr4 = MergeSortAuxiliarySpace.mergeSortAuxiliarySpace(arr3);
    assertArrayEquals(arr1, arr4);
